...
import { MeetingId, MeetingInputEvent, ParticipantEvent } from '../types/events';

/**
 * MeetingServiceAdapter インターフェース
 *
 * このインターフェースは2つの責務を持つ：
 * 1. INBOUND: サービス固有形式 → 統一MeetingInputEventに変換（Lambda関数で使用）
